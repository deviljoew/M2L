...
switch($action)
{
	...
	case 'inscription':
	{
		...
		if(strlen($motdepasse1)<5)
		{
			$erreurs="Votre mot de passe est trop court ! (minimum 5 caractères)";
		}
		else if(preg_match("[0-9]", $motdepasse1))
		{
			$erreurs="Votre mot de passe doit contenir au moins un chiffre et une majuscule !";
		}
		else{
