    ...
    <div class="col-md-12" style="padding-bottom:30px;background-color:#00000055;opacity:0.9;height:740px;">
      <p class="display-4" style="color:white;margin-left:20px;margin-top:10px;">Notes de frais validées :</p>
          ...
          <tr>
            ...
            <td class="h4" style="font-size:17px;text-align:center;"><?php if($unfrais['TRAJET'] != ""){echo "Cout trajet";}else{ echo "non renseigné";}?></td>
             ...
             <td colspan=10 style="text-align:center;"><div class="dropdown">
               ...
               <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                 <?php foreach($fraisDemandeur as $unDemandeur){ ?>
                    <a target="_blank" style="width:800px;" class="dropdown-item" href="index.php?uc=formulaire&action=genererpdf&nom=<?=$unDemandeur['NOM'];?>&prenom=<?=$unDemandeur['PRENOM']; ?>"><?php echo $unDemandeur['NOM'] . " " .  $unDemandeur['PRENOM'];?></a>
                <?php } ?>
                </div>
               </div>
             </td>
