...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="col-md-8">
      ...
      ?>
        <p class="display-4 setFrontTitle" style="color:white;margin-left:50px;margin-top:10px;">Tarif kilométrique actuel utilisé pour le(s) frais de déplacement(s) des demandeurs</p>
      <form name="modiftarif" style="margin:50px;" action="index.php?uc=Profil&action=misAjoursTarif" onSubmit="return verifChamps();" method="POST">
        <table class="table table-hover table-light table-bordered">
          ...
          <tr>
            <td colspan="2" style="text-align:center;"><button onClick="return verifChamps();" style="width:35%;margin-right:10%;" class="btn btn-success">Modifier <img src="./images/valider_white.png" width="12px" height="12px"/></button>
            <a href="index.php?uc=Profil&action=voirTarif" TITLE="Modifier le profil" style="width:35%;" class="btn btn-dark">Annuler <img src="./images/suppr_white.png" width="12px" height="12px"/></a></td>
          </tr>
        </table>
      </form>
  </div>
