...
--
-- Client :  127.0.0.1
-- Généré le :  Mer 19 Décembre 2018 à 12:50
...
(114589658, '001', 'Gibi', 'Eva', 'F', 'Saint-Pierre', 35896, 'nande', '2000-05-30'),
...
CREATE TABLE IF NOT EXISTS `demandeurs` (
  ...
  `NUM_RECU` bigint(4) NOT NULL AUTO_INCREMENT,
  `MDP` char(32) DEFAULT NULL,
  `SEXE` char(1) DEFAULT NULL,
  `DATEN` date DEFAULT NULL,
  `NUMCLUBA` char(3) DEFAULT NULL,
  PRIMARY KEY (`ADRESSE_MAIL`),
  KEY `NUM_RECU` (`NUM_RECU`)
...
INSERT INTO `demandeurs` (`ADRESSE_MAIL`, `NOM`, `PRENOM`, `RUE`, `CP`, `VILLE`, `NUM_RECU`, `MDP`, `SEXE`, `DATEN`, `NUMCLUBA`) VALUES
('aubin.cortacero@gmail.com', 'BANDILELLA', 'CLEMENT', '30 rue Widric 1er', '54600', 'Villers lès Nancy', 1, '1234567', 'M', '1998-03-24', NULL),
('cortacero@gmail.com', 'cort', 'kev', '27 Avenue Jean Moulin', '31320', 'Castanet-Tolosan', 2, 'azerty', 'M', '1996-04-06', NULL),
('fesfes@fes', 'BERBIER', 'LUCILLE', '12 rue de Marron', '54600', 'Villers lès Nancy', 3, '12', 'F', '1998-07-26', NULL),
('gibi@gmail.com', 'Gibi', 'Eva', '15 brue Alberti Damien', '31000', 'Toulouse', 4, '5t9xt556', 'F', '2018-12-11', NULL),
('sylviecortacero@orange.fr', 'CORTACERO', 'Sylvie', '27 Avenue Jean Moulin', '31320', 'Castanet-Tolosan', 5, 'Caline31', 'F', '1968-05-14', '001'),
('test@gmail.com', 'BANDILELLA', 'CLEMENT', '30 rue Widric 1er', '54600', 'Villers lès Nancy', 6, '1234567', 'M', '1998-03-24', NULL);
...
(114589658, 'gibi@gmail.com'),
(170540010340, 'fesfes@fes'),
(170540010443, 'aubin.cortacero@gmail.com'),
(170540010443, 'test@gmail.com');
...
('cortacero@gmail.com', '2018-12-04 00:00:00', 'Compétition nationale', 'Toulouse_Paris', 85, 52, 12, 500, 1),
('fesfes@es', '2018-08-29 00:00:00', 'Réunion', 'fsdf', 5, 4, 5, 7, 0),
('gibi@gmail.com', '2018-12-05 00:00:00', 'Compétition nationale', 'Toulouse_Paris', 700, 52, 12, 100, 1),
('sylviecortacero@orange.fr', '2018-11-28 00:00:00', 'compétition régionale', 'Toulouse_Paris', 700, 29, 20, 50, 1),
('sylviecortacero@orange.fr', '2018-12-05 00:00:00', 'Vacances', 'Toulouse_Paris', 52, 5, 474, 4, 0),
('sylviecortacero@orange.fr', '2018-12-11 00:00:00', 'Stage', 'Limoges_Paris', 700, 100, 150, 100, 1),
('sylviecortacero@orange.fr', '2018-12-31 00:00:00', 'Réunion', 'Limoges_Paris', 53, 41, 5, 2535, 1);
